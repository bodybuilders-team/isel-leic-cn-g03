package pt.isel.cn.sharedphotos;
...
public class SharedPhotos {
    ...
    private static final String DOWNLOADED_PHOTOS_DESTINATION = "downloadedPhotos/";
            ...
            public void receiveMessage(PubsubMessage msg, AckReplyConsumer ackReply) {
                ...
                try {
                    soper.downloadBlobFromBucket(bucketName, blobName,
                            DOWNLOADED_PHOTOS_DESTINATION + blobName);
                } catch (Exception e) {
     ...
     * Message format: <text>;<bucket name>;<blob name>
     *
     * @throws ExecutionException   if the message could not be published
     * @throws InterruptedException if the message could not be published
